#"calcCensor.R"
#Author: Sarah Ordaz
#Goal: To calculate the number of TRs for each run that need to be censored and add to data table
#Notes: This is based on "calcCensor_fromMH.R"" that I got from Michael Hallquist
#Date: Jan 28, 2012
#Mods: 2012_02_13

#NOTES: I DID NOT USE THIS FILE!!!!!!!
