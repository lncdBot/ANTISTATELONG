...
tempdir=$(mktemp -d InvASerrorCorr-tmp) 
cd $tempdir
3dMEMA \
  -prefix /Volumes/Governator/ANTISTATELONG/AgeGrpAnalyses/3dMEMA/Inv_ASerrorCorr_Rnd \
  -jobs 4 \
  -covariates /Volumes/Governator/ANTISTATELONG/AgeGrpAnalyses/3dMEMA/covariateAge_Inv_ASerrorCorr.1D \
...
tee /Volumes/Governator/ANTISTATELONG/AgeGrpAnalyses/3dMEMA/out_Inv_ASerrorCorr.log
rm $tempdir
