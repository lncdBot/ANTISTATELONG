...
tempdir=$(mktemp -d LinASerrorCorr-tmp) 
cd $tempdir
3dMEMA \
  -prefix /Volumes/Governator/ANTISTATELONG/AgeGrpAnalyses/3dMEMA/Lin_ASerrorCorr_Rnd \
  -jobs 4 \
  -covariates /Volumes/Governator/ANTISTATELONG/AgeGrpAnalyses/3dMEMA/covariateAge_Lin_ASerrorCorr.1D \
  -covariates_name 'age' \
  -missing_data 0 \
  -n_nonzero 124 \
...
tee /Volumes/Governator/ANTISTATELONG/AgeGrpAnalyses/3dMEMA/out_Lin_ASerrorCorr.log
rm $tempdir
