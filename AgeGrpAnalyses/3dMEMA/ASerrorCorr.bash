#!/usr/bin/env bash
    ...
    cd $tempdir
    3dMEMA \
      -prefix /Volumes/Governator/ANTISTATELONG/AgeGrpAnalyses/3dMEMA/RndAge_ASerrorCorr \
      -jobs 4 \
      -covariates /Volumes/Governator/ANTISTATELONG/AgeGrpAnalyses/3dMEMA/covariateAge_ASerrorCorr.1D \
      -covariates_name age \
      -missing_data 0 \
      -n_nonzero 2 \
...
tee /Volumes/Governator/ANTISTATELONG/AgeGrpAnalyses/3dMEMA/out_ASerrorCorr.log
