...
tempdir=$(mktemp -d LinAScorr-tmp) 
cd $tempdir
3dMEMA \
  -prefix /Volumes/Governator/ANTISTATELONG/AgeGrpAnalyses/3dMEMA/Lin_AScorr_Rnd \
  -jobs 4 \
  -covariates /Volumes/Governator/ANTISTATELONG/AgeGrpAnalyses/3dMEMA/covariateAge_Lin_AScorr.1D \
  -covariates_name 'age' \
  -missing_data 0 \
  -n_nonzero 128 \
...
tee /Volumes/Governator/ANTISTATELONG/AgeGrpAnalyses/3dMEMA/out_Lin_AScorr.log
rm $tempdir
