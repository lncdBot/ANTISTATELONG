...
tempdir=$(mktemp -d CubeASerrorCorr-tmp) 
cd $tempdir
3dMEMA \
  -prefix /Volumes/Governator/ANTISTATELONG/AgeGrpAnalyses/3dMEMA/Cube_ASerrorCorr_Rnd \
  -jobs 4 \
  -covariates /Volumes/Governator/ANTISTATELONG/AgeGrpAnalyses/3dMEMA/covariateAge_Cube_ASerrorCorr.1D \
...
tee /Volumes/Governator/ANTISTATELONG/AgeGrpAnalyses/3dMEMA/out_Cube_ASerrorCorr.log
rm $tempdir
